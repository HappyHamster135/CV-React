    ...
    return (
        <main className="cv-page">
            <header className="cv-header">
                ...
                <p className="cv-intro">Erfaren och målinriktad tekniker med bred kompetens inom Programmering, design och nätverksteknik.</p>
            </header>
            ...
            <div className="cv-grid">
                ...
                <aside className="cv-side-col">
                    ...
                    <section className="cv-sidebar-box">
                        <h2>Språk</h2>
                        <p>Svenska, Engelska, Norska & Italienska</p>
                    </section>
                </aside>
            </div>
        </main>
