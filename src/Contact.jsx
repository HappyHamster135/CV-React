      ...
      <div className="cv-grid">
        <div className="cv-main-col">
          {isSubmitted ? (
            ...
            <form
              id="contact-form"
              action="https://formspree.io/f/meelvqvg"
              method="POST"
            ...
            >
              <div className="form-group">
                <label
                  htmlFor="name"
                  style={{ color: "var(--color-slate)", fontWeight: "bold" }}
                >
                  Namn
                </label>
                <input
        ...
        <div className="cv-side-col">
          ...
          >
            Oavsett om du har specifika frågor, bär på en spännande projektidé
            eller vill utforska ett framtida samarbete så lyssnar jag gärna.
            Använd formuläret här intill, så återkommer jag till dig så snart
            jag kan.
          </p>
        </div>
      </div>
